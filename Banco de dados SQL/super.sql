...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13-Fev-2021 às 16:24
...
INSERT INTO `itensvendidos` (`idVenda`, `idProduto`, `quantidadeVendida`, `valorProduto`, `valorTotalProduto`) VALUES
(1, 1, 12, 2.40, 28.80),
(1, 4, 3, 3.58, 10.74),
(1, 9, 10, 1.06, 10.60);
...
(3, 'Manteiga', 7.18, 60),
(4, 'Doce de morango', 3.58, 50),
(5, 'Queijo fatiado', 22.68, 60),
(6, 'Desodorante', 10.78, 100),
(7, 'Xampu', 8.38, 200),
(8, 'Condicionador', 10.68, 50),
(9, 'Sabonete', 1.06, 500),
(10, 'Cotonete', 3.00, 100);
...
ALTER TABLE `venda`
  ...
  ADD KEY `fk_Consumidor_venda` (`idConsumidor`);
...
--
ALTER TABLE `venda`
  ADD CONSTRAINT `fk_Consumidor_venda` FOREIGN KEY (`idConsumidor`) REFERENCES `consumidor` (`idConsumidor`);
COMMIT;
